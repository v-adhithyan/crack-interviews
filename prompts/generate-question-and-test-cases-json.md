...
Use this prompt with any LLM to generate a coding question and test cases as strict JSON for Crack Interviews admin entry.
...
Generate one Java 17 + Python 3 coding problem and return one strict JSON object that can be copied into Django admin fields or used by an admin JSON importer.
...
The JSON must use exactly this top-level shape:
